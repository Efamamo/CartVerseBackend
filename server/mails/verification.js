...
const sendEmailVerification = async (user) => {
  ...
  const msg = {
    ...
    subject: 'Your OTP for CartVerse',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f9f9; border-radius: 8px;">
        ...
        <div style="background-color: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
          ...
          <p style="color: #555;">Thank you for signing up with CartVerse! Please enter the OTP below to verify your email address. This code is valid for the next 10 minutes.</p>
